...
WATCHLIST = [
    ...
    "BANKBARODA.NS", "FEDERALBNK.NS", "IDFCFIRSTB.NS", "BAJFINANCE.NS", "BAJAJFINSV.NS", 
    "CHOLAFIN.NS", "SHRIRAMFIN.NS", "HDFCLIFE.NS", "SBILIFE.NS",
    ...
    "TVSMOTOR.NS", "HEROMOTOCO.NS", "ASHOKLEY.NS",

    # ENERGY, POWER & OIL
    "RELIANCE.NS", "NTPC.NS", "POWERGRID.NS", "ONGC.NS", "COALINDIA.NS", 
    "TATAPOWER.NS", "BPCL.NS", "IOC.NS", "ADANIGREEN.NS", "ADANIPOWER.NS",

    # METALS & MINING
    "TATASTEEL.NS", "HINDALCO.NS", "JSWSTEEL.NS", "JINDALSTEL.NS", "VEDL.NS", "NMDC.NS",

    # CONSUMER, FMCG & RETAIL
    "ITC.NS", "HINDUNILVR.NS", "NESTLEIND.NS", "BRITANNIA.NS", "TITAN.NS", 
    "TRENT.NS", "ASIANPAINT.NS", "TATACONSUM.NS", "MARICO.NS", "ZOMATO.NS",

    # PHARMA & HEALTHCARE
    "SUNPHARMA.NS", "DRREDDY.NS", "CIPLA.NS", "DIVISLAB.NS", "APOLLOHOSP.NS", "LUPIN.NS",

    # INFRA, DEFENSE & CAPITAL GOODS
    "LT.NS", "HAL.NS", "BEL.NS", "ABB.NS", "SIEMENS.NS", "DLF.NS", "INDIGO.NS",

    # ADANI GROUP & OTHERS
    "ADANIENT.NS", "ADANIPORTS.NS", "UPL.NS", "GRASIM.NS", "ULTRACEMCO.NS", "SRF.NS"
]
"""WATCHLIST = [
    # NIFTY 50
